...
class TestComparisonOperators(unittest.TestCase):
    ...
    def test_lt_cross_type_err(self):
        ...
        self.assertEqual(result.tail.value, "less than of int and float")
    ...
    def test_gt_cross_type_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "greater than of float and int")
    ...
    def test_le_cross_type_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "less than or equal of string and int")
    ...
    def test_ge_cross_type_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "greater than or equal of int and string")
