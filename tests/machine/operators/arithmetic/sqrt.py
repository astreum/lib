...
class TestSqrtOperator(unittest.TestCase):
    ...
    def test_sqrt_negative_err(self):
        ...
        self.assertEqual(result.tail.value, "square root of negative number")
    ...
    def test_sqrt_int_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "square root of int")
    ...
    def test_sqrt_string_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "square root of string")
    ...
    def test_sqrt_bytes_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "square root of bytes")
