...
class TestFloatOperator(unittest.TestCase):
    ...
    def test_float_from_string_ok(self):
        ...
        self.assertAlmostEqual(result.tail.value, 3.14)
    ...
    def test_float_invalid_literal_err(self):
        ...
        self.assertEqual(result.tail.value, "float: invalid literal")
    ...
    def test_float_non_atom_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "float of link")
    ...
    def test_float_wrong_length_bytes_err(self):
        ...
        self.assertTrue(_is_tagged(result, "err"))
        self.assertIsInstance(result.tail, Expr.String)
        self.assertEqual(result.tail.value, "float requires 8-byte input")
