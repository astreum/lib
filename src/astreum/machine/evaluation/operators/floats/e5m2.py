...
from astreum.machine.models.expression import Expr, e5m2_, FLOAT_TAGS
from astreum.machine.models.op_error import OpError


def handle_stack_e5m2(machine, stack: List[Expr]) -> None:
    ...
    if v._tag == "bytes":
        ...
        from astreum.machine.models.expression.expr import _E5M2_TABLE
